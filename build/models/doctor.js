...
module.exports = function (sequelize, DataTypes) {
  var Doctor = /*#__PURE__*/function (_Model) {
    function Doctor() {
      ...
      return _callSuper(this, Doctor, arguments);
    }
    _inherits(Doctor, _Model);
    return _createClass(Doctor, null, [{
      key: "associate",
      value:
      /**
      ...
      function associate(models) {
        Doctor.belongsToMany(models.Category, {
          through: models.DoctorCategory,
          foreignKey: 'doctor_id'
        });
        Doctor.belongsToMany(models.Schedule, {
          through: models.DoctorSchedule,
          foreignKey: 'doctor_id'
        });
      }
    }]);
