...
module.exports = function (sequelize, DataTypes) {
  var Appointment = /*#__PURE__*/function (_Model) {
    function Appointment() {
      ...
      return _callSuper(this, Appointment, arguments);
    }
    _inherits(Appointment, _Model);
    return _createClass(Appointment, null, [{
      key: "associate",
      value:
      /**
      ...
      function associate(models) {
        Appointment.belongsTo(models.Type, {
          foreignKey: 'type_id'
        });
        ...
        Appointment.belongsTo(models.DoctorSchedule, {
