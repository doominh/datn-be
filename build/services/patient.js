...
var getMedicalRecord = function getMedicalRecord(data) {
  return new Promise( /*#__PURE__*/function () {
    var _ref7 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee7(resolve, reject) {
      var patient_id, patient, rawData, records;
...
var getAllByDoctorID = function getAllByDoctorID(data) {
  return new Promise( /*#__PURE__*/function () {
    var _ref8 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee8(resolve, reject) {
      var doctor_id, doctor, rawData, IDList, patients;
...
var createPatient = function createPatient(data) {
  return new Promise( /*#__PURE__*/function () {
    var _ref9 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee9(resolve, reject) {
      var patientByEmail, patientByPhone, patient_id, hashedPassword, newPatient, token;
      return _regeneratorRuntime().wrap(function _callee9$(_context9) {
        while (1) switch (_context9.prev = _context9.next) {
          ...
          case 7:
            patientByEmail = _context9.sent;
            _context9.next = 10;
            return getByPhone(data.phone);
          case 10:
            patientByPhone = _context9.sent;
            if (!patientByEmail) {
              _context9.next = 15;
              break;
            }
...
var updatePatient = function updatePatient(data) {
  return new Promise( /*#__PURE__*/function () {
    var _ref10 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee10(resolve, reject) {
      var patient_id, patient, patientByPhone, newInfo, result;
      return _regeneratorRuntime().wrap(function _callee10$(_context10) {
        while (1) switch (_context10.prev = _context10.next) {
          ...
          case 8:
            ...
            return getByPhone(data.phone);
          case 12:
            patientByPhone = _context10.sent;
      ...
      return _regeneratorRuntime().wrap(function _callee11$(_context11) {
        while (1) switch (_context11.prev = _context11.next) {
          ...
          case 8:
            ...
            return getByPhone(data.phone);
          case 12:
            patientByPhone = _context11.sent;
            if (!(patientByPhone && patientByPhone.patient_id !== patient_id)) {
              _context11.next = 17;
              break;
            }
