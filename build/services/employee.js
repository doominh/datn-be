...
var getAllBySchedule = function getAllBySchedule(data) {
  return new Promise( /*#__PURE__*/function () {
    var _ref7 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee7(resolve, reject) {
      var employeeSchedules, employeeIDList, employees, available, unavailable;
...
var createEmployee = function createEmployee(data) {
  return new Promise( /*#__PURE__*/function () {
    var _ref8 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee8(resolve, reject) {
      var employeeByEmail, employeeByPhone, doctorByEmail, doctorByphone, employee_id, is_admin, hashedPassword, newEmployee, token;
      return _regeneratorRuntime().wrap(function _callee8$(_context8) {
        while (1) switch (_context8.prev = _context8.next) {
          ...
          case 7:
            employeeByEmail = _context8.sent;
            _context8.next = 10;
            return getByPhone(data.phone);
          case 10:
            employeeByPhone = _context8.sent;
            _context8.next = 13;
          ...
          case 25:
            is_admin = false;
            _context8.t0 = data.role;
            _context8.next = _context8.t0 === 2 ? 29 : _context8.t0 === 3 ? 32 : _context8.t0 === 5 ? 34 : 36;
            break;
          case 29:
            //quản trị viên
...
var updateEmployee = function updateEmployee(data) {
  return new Promise( /*#__PURE__*/function () {
    var _ref9 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee9(resolve, reject) {
      var employee_id, employee, employeeByEmail, employeeByPhone, doctorByEmail, doctorByPhone, newInfo, result, token;
      return _regeneratorRuntime().wrap(function _callee9$(_context9) {
        while (1) switch (_context9.prev = _context9.next) {
          ...
          case 8:
            ...
            return getByEmail(data.email);
          case 12:
            employeeByEmail = _context9.sent;
            _context9.next = 15;
            return getByPhone(data.phone);
          case 15:
            employeeByPhone = _context9.sent;
            _context9.next = 18;
            return _index["default"].Doctor.findOne({
              where: {
                email: data.email
...
var updateProfile = function updateProfile(data) {
  return new Promise( /*#__PURE__*/function () {
    var _ref10 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee10(resolve, reject) {
      var employee_id, employee, employeeByPhone, doctorByPhone, newInfo, result;
      return _regeneratorRuntime().wrap(function _callee10$(_context10) {
        while (1) switch (_context10.prev = _context10.next) {
          ...
          case 8:
            ...
            return getByPhone(data.phone);
          case 12:
            employeeByPhone = _context10.sent;
            _context10.next = 15;
            return _index["default"].Doctor.findOne({
              where: {
                phone: data.phone
