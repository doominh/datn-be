...
var createSession = function createSession(data) {
  return new Promise(/*#__PURE__*/function () {
    var _ref4 = _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee4(resolve, reject) {
      var session, session_id, newSession, _t4;
      return _regenerator().w(function (_context4) {
        while (1) switch (_context4.p = _context4.n) {
          ...
          case 2:
            ...
            break;
          case 3:
            session_id = _index2["default"].createID("ck");
            _context4.n = 4;
            return _index["default"].Session.create({
              session_id: session_id,
              time: data.time,
              status: data.status
            });
          case 4:
            newSession = _context4.v;
...
var updateSession = function updateSession(data) {
  return new Promise(/*#__PURE__*/function () {
    var _ref5 = _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee5(resolve, reject) {
      var session_id, session, sessionInDB, result, _t5;
      return _regenerator().w(function (_context5) {
        while (1) switch (_context5.p = _context5.n) {
          ...
          case 4:
            _context5.n = 5;
            return _index["default"].Session.update({
              time: data.time,
              status: data.status
            }, {
              where: {
    ...
    var _ref6 = _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee6(resolve, reject) {
      ...
      return _regenerator().w(function (_context6) {
        while (1) switch (_context6.p = _context6.n) {
          ...
          case 3:
            _context6.n = 4;
            return _index["default"].Session.destroy({
              where: {
                session_id: session_id
              }
            });
