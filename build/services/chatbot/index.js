...
var askGemini = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(message) {
    var _sessionData, _sessionData$waitingF, _sessionData2;
    ...
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
          ...
          if (!((_sessionData = sessionData) !== null && _sessionData !== void 0 && (_sessionData$waitingF = _sessionData.waitingFor) !== null && _sessionData$waitingF !== void 0 && _sessionData$waitingF.startsWith('booking_'))) {
            _context.next = 9;
            break;
          }
          _context.next = 6;
          return (0, _bookingFlow.handleBookingFlow)(sessionData.waitingFor, message, sessionData, patientId);
        case 6:
        ...
        case 9:
          if (!(((_sessionData2 = sessionData) === null || _sessionData2 === void 0 ? void 0 : _sessionData2.waitingFor) === 'phone_for_lookup')) {
            _context.next = 14;
            break;
          }
        ...
        case 28:
          bookingIntent = _faqPatterns.FAQ_INTENT_PATTERNS.find(function (_ref2) {
            var intent = _ref2.intent,
              regex = _ref2.regex,
              exclude = _ref2.exclude;
            return intent === 'BOOK_APPOINTMENT' && regex.test(message) && !(exclude && exclude.test(message));
          });
          if (!bookingIntent) {
            _context.next = 35;
            break;
          ...
          _context.next = 32;
          return (0, _intentHandler.handleStructuredIntent)('BOOK_APPOINTMENT', message, sessionData);
        case 32:
        ...
        case 44:
          upcomingSchedule = _faqPatterns.FAQ_INTENT_PATTERNS.find(function (_ref3) {
            var intent = _ref3.intent,
              regex = _ref3.regex,
              include = _ref3.include;
            return intent === 'ASK_UPCOMING_SCHEDULE' && regex.test(message) && (include === null || include === void 0 ? void 0 : include.test(message));
          });
          if (!upcomingSchedule) {
            _context.next = 51;
            break;
          ...
          _context.next = 48;
          return (0, _intentHandler.handleStructuredIntent)('ASK_UPCOMING_SCHEDULE', message, sessionData);
        case 48:
          ...
          return _context.abrupt("return", _result5);
        case 51:
        ...
        case 58:
          ...
          _step$value = _step.value, intent = _step$value.intent, regex = _step$value.regex, exclude = _step$value.exclude, include = _step$value.include;
        ...
        case 63:
          ...
          return _context.abrupt("return", _result6);
        case 66:
          _context.next = 58;
          break;
        case 68:
        ...
        case 98:
          ...
          console.error('[chatbot] fallback error:', (_context.t1 === null || _context.t1 === void 0 ? void 0 : _context.t1.message) || _context.t1);
          return _context.abrupt("return", {
    ...
    }, _callee, null, [[56, 70, 73, 76], [77, 98]]);
  }));
