...
var callGeminiWithFallback = exports.callGeminiWithFallback = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(contents) {
    var lastError, _i, _GEMINI_MODELS, model, _response$data$candid, _response$data$candid2, _response$data$candid3, _response$data$candid4, _response$data$candid5, response, _e$response, status;
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        ...
        case 2:
          ...
          _context.prev = 4;
          _context.next = 7;
          return _axios["default"].post(geminiUrl(model), {
            contents: contents,
            generationConfig: {
        ...
        case 11:
          ...
          console.warn("[geminiClient] model \"".concat(model, "\" b\u1ECB ").concat(status, ", th\u1EED model k\u1EBF ti\u1EBFp..."));
