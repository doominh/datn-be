...
exports.matchServiceCategory = exports.getClinicContext = exports.getAvailableSchedules = void 0;
var _index = _interopRequireDefault(require("../../models/index"));
var _moment = _interopRequireDefault(require("moment"));
var _schedule = _interopRequireDefault(require("../../services/schedule"));
var _textMatch = require("./utils/textMatch");
...
var getClinicContext = exports.getClinicContext = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee() {
    var now, _yield$Promise$all, _yield$Promise$all2, categories, services, doctors, categoryList, serviceList, doctorMap, _iterator, _step, d, id, doctorList, categoriesRaw, servicesRaw;
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        ...
        case 6:
          ...
          categoriesRaw = categories.map(function (c) {
            return c.category_name;
          }).filter(Boolean);
          servicesRaw = services.map(function (s) {
            var _s$Category2;
            return {
              name: s.service_name,
              category: ((_s$Category2 = s.Category) === null || _s$Category2 === void 0 ? void 0 : _s$Category2.category_name) || null
            };
          }).filter(function (s) {
            return s.name;
          });
...
var matchServiceCategory = exports.matchServiceCategory = /*#__PURE__*/function () {
    ...
    return _regeneratorRuntime().wrap(function _callee2$(_context2) {
      while (1) switch (_context2.prev = _context2.next) {
        case 0:
          ...
          text = (0, _textMatch.stripDiacritics)(message);
        ...
        case 6:
          _ref3 = _clinicCache || {}, _ref3$categoriesRaw = _ref3.categoriesRaw, categoriesRaw = _ref3$categoriesRaw === void 0 ? [] : _ref3$categoriesRaw, _ref3$servicesRaw = _ref3.servicesRaw, servicesRaw = _ref3$servicesRaw === void 0 ? [] : _ref3$servicesRaw;
          matchedService = servicesRaw.find(function (_ref4) {
            var name = _ref4.name;
            var normalizedName = (0, _textMatch.stripDiacritics)(name);
            if (normalizedName.length < MIN_MATCH_LENGTH) return false;
            return text.includes(normalizedName) || normalizedName.includes(text);
          });
          if (!(matchedService !== null && matchedService !== void 0 && matchedService.category)) {
            _context2.next = 10;
            break;
          }
          return _context2.abrupt("return", matchedService.category);
        case 10:
          matchedCategory = categoriesRaw.find(function (name) {
            var normalizedName = (0, _textMatch.stripDiacritics)(name);
            return normalizedName.length >= MIN_MATCH_LENGTH && text.includes(normalizedName);
          });
          return _context2.abrupt("return", matchedCategory || null);
        case 12:
        case "end":
  ...
  return function matchServiceCategory() {
  ...
  var _ref5 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee3() {
    ...
    return _regeneratorRuntime().wrap(function _callee3$(_context3) {
      while (1) switch (_context3.prev = _context3.next) {
        case 0:
          date = _args3.length > 0 && _args3[0] !== undefined ? _args3[0] : null;
        ...
        case 25:
          ...
          console.error('[getAvailableSchedules] error:', _context3.t0.message, _context3.t0.stack);
          return _context3.abrupt("return", []);
        case 29:
        case "end":
