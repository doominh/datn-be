...
var getByEmail = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee2(email) {
...
var getByPhone = /*#__PURE__*/function () {
  var _ref3 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee4(phone) {
...
var updateDoctorCategory = /*#__PURE__*/function () {
  var _ref5 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee6(data, lowerCaseID) {
        ...
        case 0:
          return _context6.abrupt("return", new Promise( /*#__PURE__*/function () {
            var _ref6 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee5(resolve, reject) {
              var categories, a, b, equal, addList, deleteList, list, result, _result, _a, _result2;
...
var getAllByCategoryID = function getAllByCategoryID(data) {
  return new Promise( /*#__PURE__*/function () {
    var _ref10 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee10(resolve, reject) {
      var category_id, category, doctorIDList, list, doctors;
...
var getAllBySchedule = function getAllBySchedule(data) {
  return new Promise( /*#__PURE__*/function () {
    var _ref11 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee11(resolve, reject) {
      var doctorSchedules, doctorIDList, doctors, available, unavailable;
      return _regeneratorRuntime().wrap(function _callee11$(_context11) {
        while (1) switch (_context11.prev = _context11.next) {
          ...
          case 7:
            doctorSchedules = _context11.sent;
            //lọc chỉ để lấy id
...
var createDoctor = function createDoctor(data) {
  return new Promise( /*#__PURE__*/function () {
    var _ref12 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee12(resolve, reject) {
      var doctorByEmail, doctorByPhone, employeeByEmail, employeeByPhone, isInDB, doctor_id, hashedPassword, newDoctor, list, token;
      return _regeneratorRuntime().wrap(function _callee12$(_context12) {
        while (1) switch (_context12.prev = _context12.next) {
          ...
          case 7:
            doctorByEmail = _context12.sent;
            _context12.next = 10;
            return getByPhone(data.phone);
          case 10:
            doctorByPhone = _context12.sent;
            _context12.next = 13;
          ...
          case 13:
            employeeByEmail = _context12.sent;
            _context12.next = 16;
            return _index["default"].Employee.findOne({
              where: {
                phone: data.phone
          ...
          case 16:
            employeeByPhone = _context12.sent;
...
var updateDoctor = function updateDoctor(data) {
  return new Promise( /*#__PURE__*/function () {
    var _ref13 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee13(resolve, reject) {
      var doctor_id, doctor, doctorByEmail, doctorByPhone, employeeByEmail, employeeByPhone, isInDB, newInfo, result_1, result_2, token;
      return _regeneratorRuntime().wrap(function _callee13$(_context13) {
        while (1) switch (_context13.prev = _context13.next) {
          ...
          case 8:
            ...
            return getByEmail(data.email);
          case 12:
            doctorByEmail = _context13.sent;
            _context13.next = 15;
            return getByPhone(data.phone);
          case 15:
            doctorByPhone = _context13.sent;
            _context13.next = 18;
            return _index["default"].Employee.findOne({
              where: {
                email: data.email
          ...
          case 18:
            employeeByEmail = _context13.sent;
            _context13.next = 21;
            return _index["default"].Employee.findOne({
              where: {
                phone: data.phone
          ...
          case 21:
            employeeByPhone = _context13.sent;
...
var updateProfile = function updateProfile(data) {
  return new Promise( /*#__PURE__*/function () {
    var _ref14 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee14(resolve, reject) {
      var doctor_id, doctor, doctorByPhone, employeeByPhone, newInfo, result;
      return _regeneratorRuntime().wrap(function _callee14$(_context14) {
        while (1) switch (_context14.prev = _context14.next) {
          ...
          case 15:
            employeeByPhone = _context14.sent;
            if (!(doctorByPhone && doctorByPhone.doctor_id !== doctor_id || employeeByPhone)) {
              _context14.next = 20;
              break;
            }
